...
export default function Header() {
  ...
  return (
    <>
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-[#ff6a1a] focus:text-white focus:rounded-lg focus:outline-none focus:ring-2 focus:ring-white"
      >
            ...
            >
              {navigationLinks.map((link, index) => (
                <motion.a
                  ...
                  className={`px-4 py-2 text-[15px] font-medium transition-colors rounded-md ${
                    pathname === link.href || (link.href !== '/' && pathname?.startsWith(link.href))
                      ? 'text-[#ff6a1a]'
                      : 'text-black dark:text-white hover:text-[#ff6a1a]'
                  }`}
