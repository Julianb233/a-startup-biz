...
export function TransferAnimation({ shape = "circle" }: { shape?: "circle" | "triangle" | "square" | "diamond" }) {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-white">
      <div className="absolute inset-0 bg-gradient-to-br from-orange-50/20 via-amber-50/10 to-white blur-3xl scale-125" />
      <div className="absolute inset-0 bg-gradient-to-tr from-white via-transparent to-orange-50/20 blur-2xl scale-125" />
