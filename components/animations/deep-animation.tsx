...
export function DeepAnimation({ shape = "circle" }: { shape?: "circle" | "triangle" | "square" | "diamond" }) {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-white">
      <div className="absolute inset-0 bg-gradient-to-br from-amber-50/20 via-orange-50/10 to-white blur-3xl scale-125" />
      <div className="absolute inset-0 bg-gradient-to-tr from-white via-transparent to-amber-50/15 blur-2xl scale-125" />
