    ...
    <main className="relative overflow-x-hidden max-w-full bg-white">
      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-black via-[#1a0a00] to-black overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-1/4 w-px h-full bg-gradient-to-b from-transparent via-[#ff6a1a] to-transparent"></div>
          <div className="absolute top-0 right-1/4 w-px h-full bg-gradient-to-b from-transparent via-[#ff6a1a] to-transparent"></div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-5 py-2 bg-[#ff6a1a]/20 border border-[#ff6a1a]/30 rounded-full mb-8">
        ...
        {/* Bottom Border */}
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[#ff6a1a] to-transparent"></div>
      </section>
      ...
      {/* Lessons Section */}
      <section className="py-20 bg-[#c0c0c0]/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-24 bg-gradient-to-br from-[#ff6a1a] to-[#ff8a3a]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="text-6xl md:text-7xl font-bold text-white mb-8">
              {clarityCall.price}
            </div>
            ...
            <a
              href="/#apply"
              className="inline-flex items-center px-10 py-5 bg-black text-white font-bold text-lg rounded-xl hover:bg-black/90 transition-all shadow-2xl hover:scale-105 transform duration-200"
            >
              {clarityCall.cta}
            </a>

            <p className="text-white/80 text-sm mt-8 max-w-2xl mx-auto italic">
