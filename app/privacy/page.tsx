      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 text-slate-600 dark:text-gray-400 space-y-2 mb-6">
            ...
            <h3 className="text-xl font-semibold text-slate-800 dark:text-gray-200 mb-3 mt-8">Automatically Collected Information</h3>
            <p className="text-slate-600 dark:text-gray-400 leading-relaxed">
          ...
          <section className="mb-12">
            ...
            <p className="text-slate-600 dark:text-gray-400 leading-relaxed mb-4">We use the information we collect to:</p>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 text-slate-600 dark:text-gray-400 space-y-2">
              <li><strong className="text-slate-700 dark:text-gray-300">Service Providers:</strong> With third-party vendors who assist in providing our services</li>
              <li><strong className="text-slate-700 dark:text-gray-300">Insurance Partners:</strong> With our underwriting partners to facilitate insurance coverage</li>
              <li><strong className="text-slate-700 dark:text-gray-300">Legal Requirements:</strong> When required by law or to protect our rights</li>
              <li><strong className="text-slate-700 dark:text-gray-300">Business Transfers:</strong> In connection with a merger, acquisition, or sale of assets</li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="mt-4 p-6 bg-slate-50 dark:bg-gray-800 rounded-xl border border-slate-200 dark:border-gray-700">
              ...
              <p className="text-slate-600 dark:text-gray-400 mt-2">
                Email: <a href="mailto:privacy@dailyeventinsurance.com" className="text-teal-600 dark:text-[#ff6a1a] hover:text-teal-700 dark:hover:text-[#ff8a4a]">privacy@dailyeventinsurance.com</a>
              </p>
            </div>
          </section>
        </div>
